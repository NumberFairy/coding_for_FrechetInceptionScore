    ...
    def train(self):
        ...
        for epoch in range(start_epoch, self.epoch):
            ...
            for idx in range(start_batch_id, self.num_batches):
                batch_images = self.data_X[idx*self.batch_size:(idx+1)*self.batch_size] # shape:(64, 28, 28, 1)
                ...
                print("Epoch: [%2d] [%4d/%4d] time: %4.4f, d_loss: %.8f, g_loss: %.8f"
                      % (epoch + 1, idx, self.num_batches, time.time() - start_time, d_loss, g_loss))
                # print('fid_xg:' + str(fid_xg))
