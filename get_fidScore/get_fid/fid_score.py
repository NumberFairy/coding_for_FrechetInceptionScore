...
parser.add_argument('--path', type=str, default=['npy/MNIST.npz', 'data_samples/WGAN_mnist_64_62'])
# parser.add_argument('--path', type=str, default=['npy/fashion-mnist.npz', 'data_samples/WGAN_GP_fashion-mnist_64_62'])
...
def _compute_statistics_of_path(path, model, batch_size, dims, cuda):
    if path.endswith('.npz'):
        ...
        imgs = imgs_tmp.transpose((0, 3, 1, 2))
